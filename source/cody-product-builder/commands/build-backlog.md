...
The feature backlog turns the plan into a concrete, ordered list of work -- it is the document every version and patch is drawn from.

Check that {{cfWorkPhase}}/feature-backlog.md does not exist.

If it does not exist:

- Copy from {{cfAssets}}/build/feature-backlog.md into {{cfWorkPhase}}
